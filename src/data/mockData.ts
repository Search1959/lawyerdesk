    ...
    branches: [
      {
        id: 'branch-1',
        firmId: 'firm-1',
        name: 'Calcutta High Court Centenary Chambers & Head Office',
        city: 'Kolkata',
        address: 'Chamber 214, Centenary Building, High Court at Calcutta, Kolkata - 700001',
        isHeadquarters: true,
      },
      {
        id: 'branch-2',
        firmId: 'firm-1',
        name: 'City Civil Court & Alipore Chambers',
        city: 'Kolkata',
        address: '2, Kiran Shankar Roy Road, B.B.D. Bagh, Kolkata - 700001',
        isHeadquarters: false,
      },
      {
        id: 'branch-3',
        firmId: 'firm-1',
        name: 'Delhi High Court & SC Chambers Wing',
        city: 'New Delhi',
...
export const mockUsers: User[] = [
  ...
  },
  {
    ...
    permissions: ['view_demo_data', 'read_only_eval'],
    isDemoUser: true,
    status: 'Active',
    is_active: true,
    is_deleted: false,
  ...
  },
  {
    ...
    permissions: ['manage_own_firm', 'create_firm_staff', 'manage_matters', 'manage_clients'],
    status: 'Active',
    is_active: true,
    is_deleted: false,
  ...
  },
  {
    ...
    permissions: ['create_matters', 'edit_matters', 'manage_documents', 'ai_drafting'],
    status: 'Active',
    is_active: true,
    is_deleted: false,
  ...
  },
  {
    ...
    phone: '+91 98201 88765',
    barCouncilRegNo: 'D/2104/2012',
    permissions: ['manage_own_firm', 'create_firm_staff', 'manage_matters'],
    status: 'Active',
    is_active: true,
    is_deleted: false,
  ...
  },
  {
    ...
    permissions: ['view_assigned_matters', 'upload_documents', 'ai_copilot'],
    status: 'Active',
    is_active: true,
    is_deleted: false,
  ...
  },
  {
    ...
    permissions: ['view_own_matters', 'view_own_invoices'],
    status: 'Active',
    is_active: true,
    is_deleted: false,
  ...
  },
  {
    ...
    barCouncilRegNo: 'D/9999/2010',
    permissions: [],
    status: 'Deleted',
    is_active: false,
    is_deleted: true,
    deleted_at: '2026-06-01T10:00:00Z',
    deleted_by: 'usr-sys-admin',
    createdAt: '2021-05-01',
  },
  {
    id: 'usr-suspended-firm',
    name: 'Managing Partner (Suspended Firm)',
    email: 'suspended.firm@apexlaw.in',
    role: 'Law Firm',
    firmId: 'firm-suspended',
  ...
  },
  {
    ...
    is_active: false,
    is_deleted: true,
    deleted_at: '2026-07-25T08:00:00Z',
    deleted_by: 'usr-sys-admin',
    createdAt: '2024-01-01',
  },
];
...
export const mockMatters: Matter[] = [
  {
    ...
    cnr: 'DLHC010004202024',
    courtSyncAt: '2026-07-28 07:00:00',
    courtSyncStatus: 'Synced',
    itemNumber: 'Item #12',
    caseStageEcourt: 'Arguments on Injunction',
    petitionerName: 'M/s Apex Infrastructure Ltd',
    respondentName: 'Union of India & Anr',
  },
  {
    id: 'matter-2',
    firmId: 'firm-1',
    ...
    cnr: 'DLSC010010922023',
    courtSyncAt: '2026-07-28 07:00:00',
    courtSyncStatus: 'Synced',
    itemNumber: 'Item #04',
    caseStageEcourt: 'Cross Examination of PW-1',
    petitionerName: 'State (NCT of Delhi)',
    respondentName: 'Dr. Ramesh K. Malhotra',
  },
  {
    id: 'matter-3',
    firmId: 'firm-1',
    ...
    cnr: 'MHMB010008912024',
    courtSyncAt: '2026-07-27 07:00:00',
    courtSyncStatus: 'Synced',
    itemNumber: 'Item #28',
    caseStageEcourt: 'Admission Hearing u/s 9',
    petitionerName: 'Puri Overseas Logistics Ltd',
    respondentName: 'Apex Global Freight Carriers Pvt Ltd',
  },
  {
    id: 'matter-4',
    firmId: 'firm-1',
    ...
    courtSyncStatus: 'Pending',
    itemNumber: 'Item #09',
    caseStageEcourt: 'Awaiting CNR Intake',
    petitionerName: 'Shri Sohanlal Jaiswal',
    respondentName: 'Prem Chand & Ors',
  },
];
